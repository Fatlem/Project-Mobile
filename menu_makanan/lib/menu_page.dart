...
class MenuPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Aplikasi Menu Makanan'),
      ),
      body: Column(
        children: [
          const SizedBox(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ListTile(
                  leading: Image.asset('assets/images/${listMenu[index].gambar}'),
                  title: Container(
                  ...
                  trailing: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PesanPage(pesananMenu: listMenu[index]),
                        ),
                      );
                    },
                  ),
